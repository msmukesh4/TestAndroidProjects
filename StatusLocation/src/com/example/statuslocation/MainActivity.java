package com.example.statuslocation;
...
//				longitude1.setText((int) lastloc.getLongitude());
//				latitude1.setText((int) lastloc.getLatitude());
				//speed1.setText((int) lastloc.getSpeed());
		...
		Button ext = (Button) findViewById(R.id.stop_service);
